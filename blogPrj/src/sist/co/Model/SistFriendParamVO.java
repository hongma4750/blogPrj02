...
public class SistFriendParamVO {
	...
	//paging & search
	private String s_category;//검색할 단어
	private String s_keyword;
	
	public SistFriendParamVO() {
	}
	...
	public String toString() {
		return "SistFriendParamVO [fnd_seq=" + fnd_seq + ", fnd_myid=" + fnd_myid + ", fnd_fndid=" + fnd_fndid
				+ ", fnd_groupname=" + fnd_groupname + ", fnd_chk=" + fnd_chk + ", fnd_foldate=" + fnd_foldate
				+ ", fnd_newAlert=" + fnd_newAlert + ", s_category=" + s_category + ", s_keyword=" + s_keyword + "]";
	}
