...
public class SistTopicPageDTO {
	...
	public SistTopicPageDTO(){}
	
	
	public SistTopicPageDTO(int t_seq, int topic_seq, String t_name, int bbs_seq, String m_id, int bbs_ca_seq,
	...
	public SistTopicPageDTO(int t_seq, int topic_seq, String t_name) {
		super();
		this.t_seq = t_seq;
		this.topic_seq = topic_seq;
		this.t_name = t_name;
