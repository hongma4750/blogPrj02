    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/blogPrj/multiplePhotoUpload.do'; //다중파일업로드 URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sCallback : '<%=request.getContextPath()%>/smarteditor/sample/photo_uploader/callback.html',  //업로드 이후  redirect 페이지 url
