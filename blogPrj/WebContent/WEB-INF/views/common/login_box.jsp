...
<ul class="nav nav-tabs" role="tablist" id="myTab">
  ...
  <%-- <li role="presentation" class="active" ><a href="settingmain.do?m_id=${login.m_id }" >내B이웃설정</a></li> 
  ...
  <li role="presentation" class="active" ><a href="blog.do?fid=${login.m_id }" title="내 블로그 가기">내 블로그 가기</a></li>
  <li role="presentation" class="active" ><a href="bbswrite.do" >글쓰기</a></li>
  <li role="presentation" class="active" ><a href="#" id="friendBlog">이웃블로그</a></li>
